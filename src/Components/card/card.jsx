...
const Cards = ({ movie }) => {
  ...
  return (
    <>
      {isLoading ? (
        <div className="w-[400px] sm:w-[350px] md:w-[300px] lg:w-[290px] xl:w-[400px] h-[450px] rounded-lg overflow-hidden border border-gray-600 ">
          <SkeletonTheme color="#202020" highlightColor="#444">
            <Skeleton height={420} duration={2} />
          </SkeletonTheme>
        </div>
      ) : (
        <div className="relative w-[400px] sm:w-[350px] md:w-[300px] lg:w-[290px] xl:[400px] h-[450px] rounded-lg overflow-hidden border border-gray-700 shadow-lg transition-transform duration-300 hover:scale-105  bg-white " >
